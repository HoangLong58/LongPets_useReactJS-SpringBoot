...
public class Order {
        ...
        public Order(Long orderId, String orderName, String orderEmail, String orderPhone, String orderAddress,
                        String orderNote, Date orderDate, Long orderTotal, Customer customerOrder, Ward wardOrder,
                        Employee employeeOrder, OrderStatus orderStatusOrder) {
                this.orderId = orderId;
                this.orderName = orderName;
                this.orderEmail = orderEmail;
                this.orderPhone = orderPhone;
